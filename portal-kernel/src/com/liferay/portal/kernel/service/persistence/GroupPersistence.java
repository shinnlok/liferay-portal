...
public interface GroupPersistence extends BasePersistence<Group> {
	...
	* @return the matching groups
	*/
	public java.util.List<Group> findByC_LikeN_S(long companyId, String name,
		boolean site);
	...
	* @return the matching groups
	*/
	public java.util.List<Group> findByC_S_A(long companyId, boolean site,
		boolean active);
	...
	* @return the matching groups
	*/
	public java.util.List<Group> findByG_C_P_S(long groupId, long companyId,
		long parentGroupId, boolean site);
	...
	* @return the matching groups
	*/
	public java.util.List<Group> findByC_P_LikeN_S(long companyId,
