...
public class SyncFileServiceTest extends BaseTestCase {
	...
	@Test
	public void testUnsyncFolder() throws Exception {
	...
	protected void testResyncFolders(
		...
		List<SyncFile> inProgressSyncFiles = syncFilePersistence.queryForEq(
			"state", SyncFile.STATE_IN_PROGRESS);

		Assert.assertEquals(expectedModifiedCount, inProgressSyncFiles.size());
