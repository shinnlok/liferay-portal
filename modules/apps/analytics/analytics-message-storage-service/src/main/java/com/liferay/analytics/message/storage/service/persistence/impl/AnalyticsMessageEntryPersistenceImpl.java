...
public class AnalyticsMessageEntryPersistenceImpl
	...
	/**
	 * Returns all the analytics message entries where companyId = &#63; and status = &#63;.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public List<AnalyticsMessageEntry> findByC_S(long companyId, int status) {
		return findByC_S(
			companyId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the analytics message entries where companyId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>AnalyticsMessageEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<AnalyticsMessageEntry> findByC_S(
	...
	/**
	 * Returns an ordered range of all the analytics message entries where companyId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>AnalyticsMessageEntryModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first analytics message entry in the ordered set where companyId = &#63; and status = &#63;.
	 *
	 * @param companyId the company ID
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AnalyticsMessageEntry findByC_S_First(
			long companyId, int status,
			OrderByComparator<AnalyticsMessageEntry> orderByComparator)
		throws NoSuchMessageEntryException {

		AnalyticsMessageEntry analyticsMessageEntry = fetchByC_S_First(
	 ...
	 */
	@Override
	public AnalyticsMessageEntry fetchByC_S_First(
		long companyId, int status,
		OrderByComparator<AnalyticsMessageEntry> orderByComparator) {

		List<AnalyticsMessageEntry> list = findByC_S(
	...
	/**
	 * Returns the last analytics message entry in the ordered set where companyId = &#63; and status = &#63;.
	 *
	 * @param companyId the company ID
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AnalyticsMessageEntry findByC_S_Last(
			long companyId, int status,
			OrderByComparator<AnalyticsMessageEntry> orderByComparator)
		throws NoSuchMessageEntryException {

		AnalyticsMessageEntry analyticsMessageEntry = fetchByC_S_Last(
			companyId, status, orderByComparator);
	 ...
	 */
	@Override
	public AnalyticsMessageEntry fetchByC_S_Last(
		long companyId, int status,
		OrderByComparator<AnalyticsMessageEntry> orderByComparator) {
	...
	/**
	 * Returns the analytics message entries before and after the current analytics message entry in the ordered set where companyId = &#63; and status = &#63;.
	 *
	 * @param analyticsMessageEntryId the primary key of the current analytics message entry
	 * @param companyId the company ID
	 * @param status the status
	 ...
	 */
	@Override
	public AnalyticsMessageEntry[] findByC_S_PrevAndNext(
			long analyticsMessageEntryId, long companyId, int status,
			OrderByComparator<AnalyticsMessageEntry> orderByComparator)
		throws NoSuchMessageEntryException {
		...
		try {
			...
			array[0] = getByC_S_PrevAndNext(
				session, analyticsMessageEntry, companyId, status,
	...
	protected AnalyticsMessageEntry getByC_S_PrevAndNext(
		Session session, AnalyticsMessageEntry analyticsMessageEntry,
		long companyId, int status,
		OrderByComparator<AnalyticsMessageEntry> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the analytics message entries where companyId = &#63; and status = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param status the status
	 */
	...
	/**
	 * Returns the number of analytics message entries where companyId = &#63; and status = &#63;.
	 *
	 * @param companyId the company ID
	 * @param status the status
	 * @return the number of matching analytics message entries
	...
	private static final String _FINDER_COLUMN_C_S_COMPANYID_2 =
		"analyticsMessageEntry.companyId = ? AND ";

	private static final String _FINDER_COLUMN_C_S_STATUS_2 =
		"analyticsMessageEntry.status = ?";
	...
	public AnalyticsMessageEntry updateImpl(
		...
		if (isNew && (analyticsMessageEntry.getCreateDate() == null)) {
			if (serviceContext == null) {
				analyticsMessageEntry.setCreateDate(now);
			}
			else {
		...
		if (!analyticsMessageEntryModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				analyticsMessageEntry.setModifiedDate(now);
			}
			else {
		...
		try {
			...
			if (analyticsMessageEntry.isNew()) {
				...
				analyticsMessageEntry = (AnalyticsMessageEntry)session.merge(
					analyticsMessageEntry);
			}
		}
		catch (Exception e) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				analyticsMessageEntryModelImpl.getCompanyId(),
				analyticsMessageEntryModelImpl.getStatus()
			};
			...
			if ((analyticsMessageEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					analyticsMessageEntryModelImpl.getOriginalCompanyId(),
					analyticsMessageEntryModelImpl.getOriginalStatus()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByC_S = new FinderPath(
			...
			AnalyticsMessageEntryModelImpl.COMPANYID_COLUMN_BITMASK |
			AnalyticsMessageEntryModelImpl.STATUS_COLUMN_BITMASK |
			AnalyticsMessageEntryModelImpl.CREATEDATE_COLUMN_BITMASK);
