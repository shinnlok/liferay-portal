...
/**
 * Provides the local service interface for AnalyticsMessageEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AnalyticsMessageEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnalyticsMessageEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnalyticsMessageEntryLocalServiceUtil} to access the analytics message entry local service. Add custom service methods to <code>com.liferay.analytics.message.storage.service.impl.AnalyticsMessageEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
