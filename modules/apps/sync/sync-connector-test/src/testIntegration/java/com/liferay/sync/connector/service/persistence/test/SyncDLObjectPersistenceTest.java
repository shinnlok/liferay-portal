...
package com.liferay.sync.connector.service.persistence.test;
...
import com.liferay.sync.connector.service.persistence.SyncDLObjectUtil;
...
public class SyncDLObjectPersistenceTest {
	...
	protected OrderByComparator<SyncDLObject> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("SyncDLObject",
			...
			true, "changeLog", true, "extraSettings", true, "version", true,
			"versionId", true, "size", true, "checksum", true, "event", true,
