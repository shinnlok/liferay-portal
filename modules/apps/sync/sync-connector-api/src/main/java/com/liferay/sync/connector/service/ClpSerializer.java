...
public class ClpSerializer {
	...
	public static Object translateInputSyncDLObject(BaseModel<?> oldModel) {
		SyncDLObjectClp oldClpModel = (SyncDLObjectClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getSyncDLObjectRemoteModel();
	...
	public static Object translateOutputSyncDLObject(BaseModel<?> oldModel) {
		SyncDLObjectClp newModel = new SyncDLObjectClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setSyncDLObjectRemoteModel(oldModel);
