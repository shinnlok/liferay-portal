 ...
 * @see com.liferay.blogs.service.persistence.impl.BlogsStatsUserPersistenceImpl
 * @generated
 */
public class BlogsStatsUserUtil {
	...
	*/
	public static BlogsStatsUser findByGroupId_First(long groupId,
		OrderByComparator<BlogsStatsUser> orderByComparator)
		throws com.liferay.blogs.exception.NoSuchStatsUserException {
	...
	*/
	...
	private static ServiceTracker<BlogsStatsUserPersistence, BlogsStatsUserPersistence> _serviceTracker =
		ServiceTrackerFactory.open(BlogsStatsUserPersistence.class);
}