...
@Component(
	...
	property = {
		...
		"mvc.command.name=/submit/SubmitForm"
	},
	service = MVCRenderCommand.class
)
public class SubmitFormMVCRenderCommand implements MVCRenderCommand {
