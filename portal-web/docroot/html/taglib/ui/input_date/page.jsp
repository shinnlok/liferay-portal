...
String dayParamId = HtmlUtil.replaceNonWordCharacters(dayParam);
String monthParamId = HtmlUtil.replaceNonWordCharacters(monthParam);
String nameId = HtmlUtil.replaceNonWordCharacters(name);
String yearParamId = HtmlUtil.replaceNonWordCharacters(yearParam);
%>
